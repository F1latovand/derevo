...
<body>
    ...
    <?php if (isset($_SESSION['login'])) { ?>
      ...
      <div class="cart">
        ...
        <form action="exit.php" method="post">
          <input style="font-family: Century Gothic;background-color: #ffffff;padding: 0px;font-size: 20px;border: none;color: grey;font-weight:bold;cursor: pointer;" type="submit" name="exit" value="Выйти">
        </form>
      </div>
    <?php } else { ?>
      <div class="cart">
  ...
  <div class="best">
    ...
    <?php if ($result = $link->query($sql)) : ?>
      <?php foreach ($result as $row) : ?>
        <div class='image'>
          <a href="?id=<?= $row['id'] ?>"><img style="object-fit: cover; height: 100px; width: auto;" src="image/products/<?= $row['img'] ?>"></a></br>
          <a class="titletext"><?= $row['title'] ?></a></br>
          <a><?= $row['price'] ?> Руб.</a></br>
          <?php
          if (isset($_SESSION['login'])) { ?>
  ...
  <form action="pageno.php" method="get">
    <ul class="pagination">
      <li><a class="pagstyle" href="?pageno=1">Первая страница</a></li>
      ...
      <li><a class="pagstyle" href="?pageno=<?php echo $total_pages; ?>">Последняя страница</a></li>
    </ul>
  </form>
  <hr>
  <div class="cate">
    ...
    <div class="cate_img">
      <figure id="image"><a href="divani/divani.php"><img width="400" height="250" src="image/cate1.png" />
          <figcaption class="figc">Диваны<br /></figcaption>
        </a></figure>
      <figure id="image"><a href="stenki/stenki.php"><img width="400" height="250" src="image/cate2.png" />
          <figcaption class="figc">Стенки<br /></figcaption>
        </a></figure>
      <figure id="image"><a href="shkafi/shkafi.php"><img width="400" height="250" src="image/cate3.png" />
          <figcaption class="figc">Шкафы<br /></figcaption>
        </a></figure>
      <figure id="image"><a href="krovati/krovati.php"><img width="400" height="250" src="image/cate4.png" />
